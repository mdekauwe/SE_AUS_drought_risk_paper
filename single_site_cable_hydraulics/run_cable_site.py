...
if __name__ == "__main__":
    ...
    shutil.move(out_fname, os.path.join(output_dir, "standard_tumba.nc"))
    ...
    site = met_subset[0].split(".")[0]
    out_fname = os.path.join(output_dir, "%s_out.nc" % (site))
    shutil.move(out_fname, os.path.join(output_dir, "standard_wombat.nc"))
    ...
    site = met_subset[0].split(".")[0]
    out_fname = os.path.join(output_dir, "%s_out.nc" % (site))
    shutil.move(out_fname, os.path.join(output_dir, "hydraulics_wombat.nc"))
