...
def main(fname1, fname2, fname3, met_fname1, met_fname2, met_fname3, odir,
         labelsx):
    SEC_2_HLFHOUR = 1800.
    ...
    print(fname1, met_fname1)
    print(fname2, met_fname2)
    print(fname3, met_fname3)
    ...
    axx2.set_ylabel("Cumulative Rainfall (mm)")

    ax1.legend(numpoints=1, loc=(0.01, 0.14), frameon=False)
    axx1.legend(numpoints=1, loc=(0.01, 0.44), frameon=False)
...
if __name__ == "__main__":
    ...
    labelsx = ["30.40$^{\circ}$S,151.60$^{\circ}$E", \
               "31.10$^{\circ}$S,150.95$^{\circ}$E", \
               "31.10$^{\circ}$S,142.50$^{\circ}$E"]
    odir = "/Users/mdekauwe/Dropbox/Drought_risk_paper/figures/figs"
    #odir = "/Users/mdekauwe/Desktop"
    main(fname1, fname2, fname3, met_fname1, met_fname2, met_fname3, odir,
         labelsx)
